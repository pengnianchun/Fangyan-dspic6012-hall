...
void EEROM_ReadSingleMiles(void) {
    unsigned int dump[3];
    dump[0] = EEROM_ReadLowMiles(__builtin_tbladdress(&EE_TOTAL_MILES_LOW_1));
    dump[1] = EEROM_ReadLowMiles(__builtin_tbladdress(&EE_TOTAL_MILES_LOW_2));
    dump[2] = EEROM_ReadLowMiles(__builtin_tbladdress(&EE_TOTAL_MILES_LOW_3));
